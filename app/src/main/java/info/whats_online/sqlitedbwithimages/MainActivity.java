...
//        startActivityForResult(photoPickerIntent, 2);
            ...
            case 2:
                if(resultCode == RESULT_OK){
                   choosenImage = data.getData();
                    String mimeType = getContentResolver().getType(choosenImage);
                    Toast.makeText(this, "db   "+choosenImage, Toast.LENGTH_LONG).show();
                    Log.e("tag",""+choosenImage);
    ...
    private void addContact(){
      //  getValues();
        try {
            db.addContacts(new Contact(fname.getText().toString(), choosenImage.toString()));
